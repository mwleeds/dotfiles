...
sudo apt-get install python3 vim sl openssh-server clang gimp vlc chromium-browser git build-essential npm nodejs pdftk tree iotop htop gparted screen curl npm ghc mit-scheme valgrind traceroute fail2ban
